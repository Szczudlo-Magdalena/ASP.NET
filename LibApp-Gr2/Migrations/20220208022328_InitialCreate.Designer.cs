...
namespace LibApp.Migrations
{
    ...
    [Migration("20220208022328_InitialCreate")]
            ...
            modelBuilder.Entity("LibApp.Models.Book", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateAdded = new DateTime(2022, 2, 8, 3, 23, 28, 50, DateTimeKind.Local).AddTicks(6691),
                            GenreId = (byte)8,
                        ...
                        new
                        {
                            Id = 2,
                            AuthorName = "Bruce Eckel",
                            DateAdded = new DateTime(2022, 2, 8, 3, 23, 28, 52, DateTimeKind.Local).AddTicks(234),
                            GenreId = (byte)8,
            ...
            modelBuilder.Entity("LibApp.Models.Customer", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 3,
                            Birthdate = new DateTime(1990, 7, 21, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            HasNewsletterSubscribed = true,
                            MembershipTypeId = (byte)1,
                            Name = "Józef Śmietana"
                        });
            ...
            modelBuilder.Entity("LibApp.Models.Rental", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BookId = 1,
                            CustomerId = 1,
                            DateRented = new DateTime(2022, 2, 8, 3, 23, 28, 52, DateTimeKind.Local).AddTicks(1431)
                        },
                        new
                        {
                            Id = 2,
                            BookId = 1,
                            CustomerId = 2,
                            DateRented = new DateTime(2022, 2, 8, 3, 23, 28, 52, DateTimeKind.Local).AddTicks(1664)
                        },
                        new
                        {
                            Id = 3,
                            BookId = 1,
                            CustomerId = 3,
                            DateRented = new DateTime(2022, 2, 8, 3, 23, 28, 52, DateTimeKind.Local).AddTicks(1673)
                        });
                });
